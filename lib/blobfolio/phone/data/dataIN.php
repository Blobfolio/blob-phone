...
class dataIN extends data {
	...
	const FORMATS = array(
		...
		'(\d{3})(\d{3})(\d{4})'=>'$1 $2 $3',
		'(\d{4})(\d{3})(\d{3})'=>'$1 $2 $3',
		'(\d{2})(\d{3})(\d{4})(\d{3})'=>'$1 $2 $3 $4',
		'(\d{4})(\d{2})(\d{4})'=>'$1 $2 $3',
		'(\d{4})(\d{4,5})'=>'$1 $2',
		'(\d{4})(\d{2,4})(\d{4})'=>'$1 $2 $3',
		'(\d{4})(\d{3,4})(\d{4})'=>'$1 $2 $3',
		'(\d{4})(\d{3})(\d{3})(\d{3})'=>'$1 $2 $3 $4'
	);
